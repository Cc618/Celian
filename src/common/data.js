...
[
  {
    ...
    "content_fr": "Stage de 7 semaines au sein de Medical&Digital (filiale d'Infotrafic).<br>J'ai été chargé d'optimiser le logiciel open source d'imagerie médicale Weasis. Le but est de l'utiliser sur Raspberry Pi. De plus, j'ai mis en place un serveur PACS (imagerie médicale) sécurisé afin de l'utiliser dans Weasis.<br> Lors de ce stage, beaucoup de recherche a été faite. La plupart du code était écrit en Java et j'ai appris à utiliser Docker.",
    "content_en": "7 weeks internship at Medical&Digital (branch of Infotrafic).<br>I have been asked to optimize Weasis, an open source viewer for DICOM files (medical images). Weasis was used in Raspberry Pi devices.<br>In addition, I also have set up a secured PACS server used to manage medical files such as DICOM. The server was used alongside Weasis. During this internship, most of the code has been written in Java, I have also learnt to use Docker.",
